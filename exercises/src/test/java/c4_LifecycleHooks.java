...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    public void no_subscription_no_gains() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doOnSubscribe(item -> hooksTriggered.add("subscribe"))//todo: change this line only
                ;
    ...
    public void atomic_counter() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doOnNext(item -> {System.out.println(item); counter.incrementAndGet();})//todo: change this line only
                ;
    ...
    public void one_to_catch_them_all() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                .doFinally((item) -> hooksTriggeredCounter.incrementAndGet())//todo: change this line only
                ;
    ...
    public void one_to_rule_them_all() {
        ...
        Flux<Integer> flux = Flux.just(1, 2, 3)
                .doOnEach(item -> signals.add("ON_NEXT"))
                .doFinally(ceva -> {signals.remove(signals.size()-1); signals.add("ON_COMPLETE");})//todo: change this line only
                ;
